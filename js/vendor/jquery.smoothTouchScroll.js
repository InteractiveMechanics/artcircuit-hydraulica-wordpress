    ...
    $.widget( "thomaskahn.smoothTouchScroll" , {
		...
		**********************************************************/
		recalculateScrollableArea: function () {
            ...
            var wrapperWidth = 1500;
            
            $('#auto-center').width(windowWidth).css('left', (wrapperWidth - windowWidth/2));
            

			// Move to the starting position
			el.data("scrollWrapper").scrollLeft(wrapperWidth - windowWidth/2);
			el.data("scrollXPos", (wrapperWidth - windowWidth/2));
		},
		/**********************************************************
